...
QP "quantizaer" is a number, the smaller the number the higher in the quality, the higher the quality the higher the file size (i.e, 0 is the highest [quality lossless compression] and 51 is the lowest quality)
